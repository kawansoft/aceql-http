...
2. If you don’t use Maven: the [aceql-http-client-all-4.1.jar](https://www.aceql.com/SoftwareDownload?software=aceql-http-client-sdk-all-4.1.jar&version=5.0.2) file contains the SDK with all dependencies.
...
The aceql module supports Python 3.6–3.8. 
