...
- [sampledb_mysq.txt](https://www.aceql.com/rest/soft/6.3/src/sampledb_mysql.txt )
- [sampledb_postgresql.txt](https://www.aceql.com/rest/soft/6.3/src/sampledb_postgresql.txt)
- [sampledb_ms_sql_serverl.txt](https://www.aceql.com/rest/soft/6.3/src/sampledb_ms_sql_server.txt)
- [sampledb_oracle_database.txt](https://www.aceql.com/rest/soft/6.3/src/sampledb_oracle_database.txt)


For other databases engines, just tailor the file as indicated: [sampledb_other_databases.txt](https://www.aceql.com/rest/soft/6.3/src/sampledb_other_databases.txt)
...
This will create the `aceql-http-6.3` folder.

The full path to the `aceql-http-6.3` installation folder will be surnamed `ACEQL_HOME` in following text.

Example: if you run `aceql-http-6.3.run` from `/home/mike`, then software is installed in

 `/home/mike/aceql-http-6.3` which is the value of `ACEQL_HOME`.
...
```bash
$ PATH=$PATH:/path/to/aceql-http-6.3/bin/;export PATH
```
...
[ACEQL HTTP START] AceQL HTTP Community v6.3 - 05-Dec-2020
...
From now, you can read the [API User Guide](https://www.aceql.com/DocDownload?doc=https://github.com/kawansoft/aceql-http/blob/master/aceql-http-6.3-user-guide-api.md) to learn how to:
...
3.    Download this Python class: [my_remote_connection.py](https://www.aceql.com/rest/soft/6.3/src/my_remote_connection.py)
...
The `select_customer_and_orderlog` method of [my_remote_connection.py](https://www.aceql.com/rest/soft/6.3/src/my_remote_connection.py) displays back the inserted values.
