 ...
 *
 */
public class SqlWebServerStartAuthWindows {
     ...
     * no constructor
     */
    private SqlWebServerStartAuthWindows() {
	...
	map.put(port, "I:\\_dev_awake\\aceql-http-main\\aceql-http\\conf_test\\aceql-server-auth-windows.properties");
	start(port);
