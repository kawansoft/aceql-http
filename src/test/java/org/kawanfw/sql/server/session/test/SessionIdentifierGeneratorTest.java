...
/**
 * 
 * Token ID generator with 26 long strings.
 * Inspired from http://stackoverflow.com/questions/41107/how-to-generate-a-random-alpha-numeric-string
 * 
...
public class SessionIdentifierGeneratorTest {
	...
	for (int i = 0; i < 10_000_000 ; i++) {
	    ...
	    if (i% 10000 == 0) System.out.println(new Date() + " " + i);
	}
	...
	for (int i = 0; i < 10_000_000 ; i++) {
		...
		throw new IllegalArgumentException("failure: string already in set: " + s);
	    }
	}
