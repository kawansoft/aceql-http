...
public class ServletParametersStore {
     ...
     * 
     * @param database
     *            the database to store the parameter name and value for
     * @param InitParamNameValuePair
     *            the init paramater name and value
     */
    public static void setInitParameter(String database,
     ...
     * 
     * @param database
     *            the database name to return the init parameter for
     * @param initParamName
