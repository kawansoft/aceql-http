 ...
 * <br>
 * See <a href="https://jwt.io">https://jwt.io</a> for more info on JWT.
 * <br>
 * <br>
...
public class JwtSessionConfigurator implements SessionConfigurator {
    ...
    /* (non-Javadoc)
     * @see org.kawanfw.sql.api.server.session.SessionConfigurator#generateSessionId(java.lang.String, java.lang.String)
     */
    /**
    ...
    /* (non-Javadoc)
     * @see org.kawanfw.sql.api.server.session.SessionConfigurator#getUsername(java.lang.String)
     */
    /**
    ...
    /* (non-Javadoc)
     * @see org.kawanfw.sql.api.server.session.SessionConfigurator#getDatabase(java.lang.String)
     */
    /**
    ...
    /* (non-Javadoc)
     * @see org.kawanfw.sql.api.server.session.SessionConfigurator#getCreationTime(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.kawanfw.sql.api.server.session.SessionConfigurator#remove(java.lang.String)
     */
    @Override
	...
	try {
	    ...
	    if (now.getTime() - issuedAt.getTime() > (getSessionTimelife() * 60 * 1000)) {
		return false;
	    }
    ...
    /* (non-Javadoc)
     * @see org.kawanfw.sql.api.server.session.SessionConfigurator#getSessionTimelife()
     */
    /**
