 ...
 * {@code user.home/.kawansoft/properties_password_manager.properties}.
 * <br/><br/>
 * This default implementation is provided asis, password is not secured if 
 * an attacker gets access to the server.
 * <br/>
...
public class DefaultPropertiesPasswordManager implements PropertiesPasswordManager {
    ...
    /**
     * Returns the password value of property contained in {@code user.home/.kawansoft/properties_password_manager.properties}.
     * <br>
