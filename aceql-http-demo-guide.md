...
- [sampledb_mysq.txt](https://docs.aceql.com/rest/soft/10.0/src/sampledb_mysql.txt )
- [sampledb_postgresql.txt](https://docs.aceql.com/rest/soft/10.0/src/sampledb_postgresql.txt)
- [sampledb_ms_sql_serverl.txt](https://docs.aceql.com/rest/soft/10.0/src/sampledb_ms_sql_server.txt)
- [sampledb_oracle_database.txt](https://docs.aceql.com/rest/soft/10.0/src/sampledb_oracle_database.txt)


For other databases engines, just tailor the file as indicated: [sampledb_other_databases.txt](https://docs.aceql.com/rest/soft/10.0/src/sampledb_other_databases.txt)
...
This will create the `aceql-http-10.0` folder.

The full path to the `aceql-http-10.0` installation folder will be surnamed `ACEQL_HOME` in following text.

Example: if you run `aceql-http-10.0.run` from `/home/mike`, then software is installed in

 `/home/mike/aceql-http-10.0` which is the value of `ACEQL_HOME`.
...
```bash
$ PATH=$PATH:/path/to/aceql-http-10.0/bin/;export PATH
```
...
[ACEQL HTTP START] AceQL HTTP Community v10.0 - 20-Dec-2021
...
3.    Download this Python class: [my_remote_connection.py](https://docs.aceql.com/rest/soft/10.0/src/my_remote_connection.py)
...
The `select_customer_and_orderlog` method of [my_remote_connection.py](https://docs.aceql.com/rest/soft/10.0/src/my_remote_connection.py) displays back the inserted values.
