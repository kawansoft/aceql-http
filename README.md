...
- [kawansoft_example_mysq.txt](https://www.aceql.com/rest/soft/2.0/src/kawansoft_example_mysql.txt )
- [kawansoft_example_postgresql.txt](https://www.aceql.com/rest/soft/2.0/src/kawansoft_example_postgresql.txt)
- [kawansoft_example_ms_sql_serverl.txt](https://www.aceql.com/rest/soft/2.0/src/kawansoft_example_ms_sql_server.txt)
- [kawansoft_example_oracle_database.txt](https://www.aceql.com/rest/soft/2.0/src/kawansoft_example_oracle_database.txt)


For other databases engines, just tailor the file as indicated: [kawansoft_example_other_databases.txt](https://www.aceql.com/rest/soft/2.0/src/kawansoft_example_other_databases.txt)
...
```bash
chmod +x aceql-http-2.0.run
./aceql-http-2.0.run 
```

This will create the `aceql-http-2.0` folder.

The full path to the `aceql-http-2.0` installation folder will be surnamed `ACEQL_HOME` in following text.

Example: if you run `aceql-http-2.0.run` from `/home/mike`, then software is installed in

 `/home/mike/aceql-http-2.0` which is the value of `ACEQL_HOME`.
...
Add to your PATH the path to the bin directory of `aceql-http-2.0` installation:

```bash
$ PATH=$PATH:/path/to/aceql-http-2.0/bin/;export PATH
```
...
```*
AceQL HTTP Professional v2.0 - 28-feb-2018
```
...
[ACEQL HTTP START] AceQL HTTP Open Source v2.0 – 28-feb-2018
[ACEQL HTTP START] Using properties file:
[ACEQL HTTP START]  -> /home/mike/aceql-http-2.0/conf/aceql-server.properties
...
```
[ACEQL HTTP START] Starting AceQL HTTP Web Server...
[ACEQL HTTP START] AceQL HTTP Open Source v2.0 - 27-feb-2018
[ACEQL HTTP START] Using properties file:
...
From now, you can read the [API User Guide](https://www.aceql.com/DocDownload?doc=https://github.com/kawansoft/aceql-http/blob/master/aceql-http-2.0-user-guide-api.md) to learn how to:
...
3. Download this C# source file: [MyRemoteConnection.cs](https://www.aceql.com/rest/soft/2.0/src/MyRemoteConnection.cs). Then insert it in your project. 
...
The `SelectCustomerAndOrderLogAsync()` method of [MyRemoteConnection.cs](https://www.aceql.com/rest/soft/2.0/src/MyRemoteConnection.cs) displays back the inserted values.
...
4. Download this Java source file: [MyRemoteConnection.java](https://www.aceql.com/rest/soft/2.0/src/MyRemoteConnection.java). Then insert it in the package. 
...
The `selectCustomerAndOrderLog` method of [MyRemoteConnection.java](https://www.aceql.com/rest/soft/2.0/src/MyRemoteConnection.java) displays back the inserted values.

From now on, you can read the [Java Client SDK User Guide](https://www.aceql.com/DocDownload?doc=https://github.com/kawansoft/aceql-http-client-sdk/blob/master/README.md) or run through the [SDK Javadoc](https://www.aceql.com/rest/soft/2.0/javadoc_sdk).
...
3.    Download this Python class: [my_remote_connection.py](https://www.aceql.com/rest/soft/2.0/src/my_remote_connection.py)
...
The `select_customer_and_orderlog` method of [my_remote_connection.py](https://www.aceql.com/rest/soft/2.0/src/my_remote_connection.py) displays back the inserted values.
...
You can read the [Server User Guide](https://www.aceql.com/DocDownload?doc=https://github.com/kawansoft/aceql-http/blob/master/aceql-http-2.0-user-guide-server.md). You will learn:
