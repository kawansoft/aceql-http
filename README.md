...
# AceQL HTTP v10.2   - February 7,  2022
...
```bash
$ wget https://download.aceql.com/rest/soft/10.2/download/aceql-http-10.2.run
```
...
```
AceQL HTTP Community v10.2 - 04-Jan-2022
```
...
{
    "status": "OK",
    "version": "AceQL HTTP v10.2 - 04-Jan-2022"
}         
```
