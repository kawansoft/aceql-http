...
- [Server Side Settings](#server-side-settings)
  * [Create the kawansoft_example database](#create-the-kawansoft-example-database)
  * [Linux/Unix Installation & Server Startup](#linux-unix-installation---server-startup)
...
- [kawansoft_example_mysq.txt](https://www.aceql.com/rest/soft/1.0/src/kawansoft_example_mysql.txt )
- [kawansoft_example_postgresql.txt](https://www.aceql.com/rest/soft/1.0/src/kawansoft_example_postgresql.txt)
- [kawansoft_example_ms_sql_serverl.txt](https://www.aceql.com/rest/soft/1.0/src/kawansoft_example_ms_sql_server.txt)
- [kawansoft_example_oracle_database.txt](https://www.aceql.com/rest/soft/1.0/src/kawansoft_example_oracle_database.txt)
...
This will create the `aceql-http-1.0` folder.

The full path to the `aceql-http-1.0` installation folder will be surnamed `ACEQL_HOME` in following text.

Example: if you run `aceql-http-1.0.run` from `/home/mike`, then software is installed in

 `/home/mike/aceql-http-1.0` which is the value of `ACEQL_HOME`.
...
Add to your PATH the path to the bin directory of `aceql-http-1.0` installation:

```bash
$ PATH=$PATH:/path/to/aceql-http-1.0/bin/;export PATH
```
...
[ACEQL HTTP START] AceQL HTTP Open Source v1.0 – 20-dec-2017
[ACEQL HTTP START] Using properties file:
[ACEQL HTTP START]  -> /home/mike/ aceql-http-1.0/conf/aceql-server.properties
...
3. Download this C# source file: [MyRemoteConnection.cs](https://www.aceql.com/rest/soft/1.0/src/MyRemoteConnection.cs). Then insert it in your project. 
...
2. If you don’t use Maven: the [aceql-http-client-all-1.0.jar](https://www.aceql.com/SoftwareDownload?software=aceql-http-client-sdk-all-1.0.jar&version=1.0) file contains the SDK with all dependencies.
