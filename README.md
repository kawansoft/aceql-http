...
- [kawansoft_example_mysq.txt](https://www.aceql.com/rest/soft/2.1/src/kawansoft_example_mysql.txt )
- [kawansoft_example_postgresql.txt](https://www.aceql.com/rest/soft/2.1/src/kawansoft_example_postgresql.txt)
- [kawansoft_example_ms_sql_serverl.txt](https://www.aceql.com/rest/soft/2.1/src/kawansoft_example_ms_sql_server.txt)
- [kawansoft_example_oracle_database.txt](https://www.aceql.com/rest/soft/2.1/src/kawansoft_example_oracle_database.txt)


For other databases engines, just tailor the file as indicated: [kawansoft_example_other_databases.txt](https://www.aceql.com/rest/soft/2.1/src/kawansoft_example_other_databases.txt)
...
- [AceQL-http-2.1-Setup-x64.exe](https://www.aceql.com/SoftwareDownload?software=AceQL-HTTP-2.1-Setup-x64.exe&version=2.1) if you use an [Open Source database](https://www.aceql.com/open-source-and-commercial-sql-databases.html).
- [AceQL-HTTP-Pro-2.1-Setup-x64.exe](https://www.aceql.com/SoftwareDownload?software=AceQL-HTTP-Pro-2.1-Setup-x64.exe&version=2.1) if you use a commercial database. You can get an AceQL Professional trial license key here: [https://www.aceql.com/trial](https://www.aceql.com/trial).
...
From now, you can read the [API User Guide](https://www.aceql.com/DocDownload?doc=https://github.com/kawansoft/aceql-http/blob/master/aceql-http-2.1-user-guide-api.md) to learn how to:
...
3. Download this C# source file: [MyRemoteConnection.cs](https://www.aceql.com/rest/soft/2.1/src/MyRemoteConnection.cs). Then insert it in your project. 
...
The `SelectCustomerAndOrderLogAsync()` method of [MyRemoteConnection.cs](https://www.aceql.com/rest/soft/2.1/src/MyRemoteConnection.cs) displays back the inserted values.
...
4. Download this Java source file: [MyRemoteConnection.java](https://www.aceql.com/rest/soft/2.1/src/MyRemoteConnection.java). Then insert it in the package. 
...
The `selectCustomerAndOrderLog` method of [MyRemoteConnection.java](https://www.aceql.com/rest/soft/2.1/src/MyRemoteConnection.java) displays back the inserted values.

From now on, you can read the [Java Client SDK User Guide](https://www.aceql.com/DocDownload?doc=https://github.com/kawansoft/aceql-http-client-sdk/blob/master/README.md) or run through the [SDK Javadoc](https://www.aceql.com/rest/soft/2.1/javadoc_sdk).
...
3.    Download this Python class: [my_remote_connection.py](https://www.aceql.com/rest/soft/2.1/src/my_remote_connection.py)
...
The `select_customer_and_orderlog` method of [my_remote_connection.py](https://www.aceql.com/rest/soft/2.1/src/my_remote_connection.py) displays back the inserted values.
...
You can read the [Server User Guide](https://www.aceql.com/DocDownload?doc=https://github.com/kawansoft/aceql-http/blob/master/aceql-http-2.1-user-guide-server.md). You will learn:
