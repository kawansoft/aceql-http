# AceQL HTTP v6.4 - February 17, 2021
...
Connection to the [sampledb](http://www.aceql.com/rest/soft/6.4/src/sampledb.txt) database with (MyUsername, MySecret) credentials:
