...
- [sampledb_mysq.txt](https://www.aceql.com/rest/soft/5.1/src/sampledb_mysql.txt )
- [sampledb_postgresql.txt](https://www.aceql.com/rest/soft/5.1/src/sampledb_postgresql.txt)
- [sampledb_ms_sql_serverl.txt](https://www.aceql.com/rest/soft/5.1/src/sampledb_ms_sql_server.txt)
- [sampledb_oracle_database.txt](https://www.aceql.com/rest/soft/5.1/src/sampledb_oracle_database.txt)


For other databases engines, just tailor the file as indicated: [sampledb_other_databases.txt](https://www.aceql.com/rest/soft/5.1/src/sampledb_other_databases.txt)
...
This will create the `aceql-http-5.1` folder.

The full path to the `aceql-http-5.1` installation folder will be surnamed `ACEQL_HOME` in following text.

Example: if you run `aceql-http-5.1.run` from `/home/mike`, then software is installed in

 `/home/mike/aceql-http-5.1` which is the value of `ACEQL_HOME`.
...
```bash
$ PATH=$PATH:/path/to/aceql-http-5.1/bin/;export PATH
```
...
```
AceQL HTTP Community v5.1 - 18-Jul-2020
```
...
[ACEQL HTTP START] AceQL HTTP Community v5.1 - 18-Jul-2020
...
From now, you can read the [API User Guide](https://www.aceql.com/DocDownload?doc=https://github.com/kawansoft/aceql-http/blob/master/aceql-http-5.1-user-guide-api.md) to learn how to:
...
3. Download this C# source file: [MyRemoteConnection.cs](https://www.aceql.com/rest/soft/5.1/src/MyRemoteConnection.cs). Then insert it in your project. 
...
The `SelectCustomerAndOrderLogAsync()` method of [MyRemoteConnection.cs](https://www.aceql.com/rest/soft/5.1/src/MyRemoteConnection.cs) displays back the inserted values.
...
2. If you don’t use Maven: the [aceql-http-client-all-4.1.jar](https://www.aceql.com/SoftwareDownload?software=aceql-http-client-sdk-all-4.1.jar&version=5.1) file contains the SDK with all dependencies.
3. Create an `org.kawanfw.sql.api.client.quickstart` package in your IDE.

4. Download this Java source file: [MyRemoteConnection.java](https://www.aceql.com/rest/soft/5.1/src/MyRemoteConnection.java). Then insert it in the package. 
...
The `selectCustomerAndOrderLog` method of [MyRemoteConnection.java](https://www.aceql.com/rest/soft/5.1/src/MyRemoteConnection.java) displays back the inserted values.

From now on, you can read the [Java Client SDK User Guide](https://www.aceql.com/DocDownload?doc=https://github.com/kawansoft/aceql-http-client-sdk/blob/master/README.md) or run through the [SDK Javadoc](https://www.aceql.com/rest/soft/5.1/javadoc_sdk).
...
3.    Download this Python class: [my_remote_connection.py](https://www.aceql.com/rest/soft/5.1/src/my_remote_connection.py)
...
The `select_customer_and_orderlog` method of [my_remote_connection.py](https://www.aceql.com/rest/soft/5.1/src/my_remote_connection.py) displays back the inserted values.
